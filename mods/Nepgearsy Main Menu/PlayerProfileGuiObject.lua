function PlayerProfileGuiObject:init(ws)
	...
	DelayedCalls:Add( "AntiCrash_MovingBltNotif", 0.05, function()
    	managers.menu_component._blt_notifications._panel:set_top(self._panel:bottom() + 245)
	end )

	local infamy_title = {}
	infamy_title[0] = ""
	infamy_title[1] = "Becoming Infamous"
	infamy_title[2] = "Becoming Disgraceful"
	infamy_title[3] = "Becoming Wicked"
	infamy_title[4] = "Becoming Notorious"
	infamy_title[5] = "Becoming Vicious"
	infamy_title[6] = "Becoming Villainous"
	infamy_title[7] = "Becoming Abominable"
	infamy_title[8] = "Becoming Fiendish"
	infamy_title[9] = "Becoming Heinous"
	infamy_title[10] = "Becoming Mean"
	infamy_title[11] = "Becoming Dangerous"
	infamy_title[12] = "Becoming Fearless"
	infamy_title[13] = "Becoming Nefarious"
	infamy_title[14] = "Becoming Disreputable"
	infamy_title[15] = "Becoming Fearful"
	infamy_title[16] = "Becoming Opprobrious"
	infamy_title[17] = "Becoming Shady"
	infamy_title[18] = "Becoming Savage"
	infamy_title[19] = "Becoming Abhorrent"
	infamy_title[20] = "Becoming Sly"
	infamy_title[21] = "Becoming Crafty"
	infamy_title[22] = "Becoming Shameless"
	infamy_title[23] = "Becoming Diabolical"
	infamy_title[24] = "Becoming Ferocious"
	infamy_title[25] = "Becoming Monstrous"
	...
	if next_xp_in == 0 then
		nl_text = "MAX LEVEL REACHED"
	else
		local s_next_xp_in = tostring(next_xp_in)
		nl_text = managers.money:add_decimal_marks_to_string(s_next_xp_in) .. " EXP NEEDED FOR LEVEL " .. (managers.experience:current_level() + 1)
	end
	...
	mastermind_points:set_center_x(mastermind_icon:center_x())
	...
	enforcer_points:set_center_x(enforcer_icon:center_x())
	...
	technician_points:set_center_x(technician_icon:center_x())
	...
	ghost_points:set_center_x(ghost_icon:center_x())
	...
	fugitive_points:set_center_x(fugitive_icon:center_x())
	...
	--self._make_fine_text(skill_point_unused)
