...
for _, vp in ipairs(managers.viewport:viewports()) do
   ...
   -- vp:vp():set_post_processor_effect("World", Idstring("color_grading_post"), Idstring("empty"))   --lam xam man hinh menu
  -- vp:vp():set_post_processor_effect("World", Idstring("bloom_combine_post_processor"), Idstring("bloom_combine_empty"))--
  --- vp:vp():set_post_processor_effect("World", Idstring("bloom_combine"), Idstring("bloom_combine_empty"))-- out light
    --vp:vp():set_post_processor_effect("World", Idstring("hdr_post_processor"), Idstring("empty"))--
    --vp:vp():set_post_processor_effect("World", Idstring("shadow_processor"), Idstring("empty"))  -- mat bong toi
